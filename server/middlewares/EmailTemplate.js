export const Verification_Email_Template = `
  ...
  <body>
      <div class="container">
          ...
          <div class="footer">
              <p>&copy; ${new Date().getFullYear()} CIVCHANGE. All rights reserved.</p>
          </div>
      </div>
  </body>
  </html>
...
export const Password_Reset_Email_Template = `
  ...
  <head>
      ...
      <style>
          ...
          .header { background-color: #FF9800; color: white; padding: 20px; text-align: center; font-size: 26px; font-weight: bold; }
          .content { padding: 25px; color: #333; line-height: 1.8; }
          .reset-code { display: block; margin: 20px 0; font-size: 22px; color: #FF9800; background: #fff3e0; border: 1px dashed #FF9800; padding: 10px; text-align: center; border-radius: 5px; font-weight: bold; letter-spacing: 2px; }
